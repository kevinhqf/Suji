...
interface ApiService {
    ...
    @FormUrlEncoded
    @POST("api/user/login")
    suspend fun login(@Field("phone") phone: String,@Field("password") password:String):ApiResponse<UserResponse>

    @FormUrlEncoded
    @POST("api/user/signup")
    suspend fun signup(@Field("phone") phone: String,@Field("password") password:String):ApiResponse<UserResponse>
